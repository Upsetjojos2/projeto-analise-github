...
amazon_rep = DadosRepositorios('netflix')
ling_mais_usadas_netflix = amazon_rep.cria_df_linguagens()
#print(ling_mais_usadas_netflix)

amazon_rep = DadosRepositorios('spotify')
ling_mais_usadas_spotify = amazon_rep.cria_df_linguagens()
#print(ling_mais_usadas_spotify)

ling_mais_usadas_amzn.to_csv('dados/amzn.csv')
ling_mais_usadas_netflix.to_csv('dados/netflix.csv')
ling_mais_usadas_spotify.to_csv('dados/spotify.csv')
