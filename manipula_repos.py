...
novo_repo = ManipulaRepositorios('Upsetjojos2')
...
novo_repo.add_arquivo(nome_repo, 'linguagens_amzn.csv', 'dados/amzn.csv')
novo_repo.add_arquivo(nome_repo, 'linguagens_netflix.csv', 'dados/netflix.csv')
novo_repo.add_arquivo(nome_repo, 'linguagens_spotify.csv', 'dados/spotify.csv')